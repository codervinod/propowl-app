    ...
    <body>
      ...
      <div class="footer">
        <div class="branding">
          ...
          <span class="brand-name">PropOwl</span>
        </div>
        <div class="tagline">The wise way to manage rentals</div>
        <div style="font-size: 9px; color: #92400e;">
          Generated from propowl.ai on ${new Date().toLocaleDateString()} at ${new Date().toLocaleTimeString()}<br>
